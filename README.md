...
1. **`HOT 100 BREAKDOWN.xlsx`** — the raw data layer. Tracks every charting song's weekly points, cumulative total, peak position, and weeks-on-chart, going back through 2025 and into 2026 (43+ weeks tracked in the current year alone).
...
As of **Week 43**, the system is tracking **750+ songs** and **30,000+ individual weekly data points** across both files.
...
## Example — Week 43, 2026 (current top 5)

| Rank | +/- | Song | Artist | Points | Gain | Peak | WO |
|------|-----|------|--------|--------|------|------|----|
| 1 | = | Choosin' Texas | Ella Langley | 9,773 | +294 | 1 | 42 |
| 2 | = | Man I Need | Olivia Dean | 8,091 | +148 | 2 | 50 |
